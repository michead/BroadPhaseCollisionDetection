...
__kernel void kernel__radixLocalSort(__global KV_TYPE* data, const int bitOffset, const int N){
...
__kernel void kernel__localHistogram(__global KV_TYPE* data, const int bitOffset, __global int* radixCount, __global int* radixOffsets, const int N){
...
__kernel void kernel__radixPermute(__global const KV_TYPE* dataIn, __global KV_TYPE* dataOut, __global const int* histSum, __global const int* blockHists, const int bitOffset, const int N, const int numBlocks){
