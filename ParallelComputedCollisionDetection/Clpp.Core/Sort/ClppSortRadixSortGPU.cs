...
namespace Clpp.Core.Sort
{
    public class ClppSortRadixSortGPU : ClppSort
    {
        ...
        public ClppSortRadixSortGPU(ClppContext clppContext, long maxElements, long bits, bool keysOnly) : base(clppContext)
        {
            ...
            System.IO.StreamReader kernelStream = new System.IO.StreamReader("clppSortRadixSortGPU.cl");
            _kernelsSource = kernelStream.ReadToEnd();
            //_kernelsSource = GetKernelSource("clppSortRadixSortGPU.cl");
            //Console.Write(_kernelsSource);
